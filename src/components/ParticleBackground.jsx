  ...
  useEffect(() => {
    ...
    class Particle {
      constructor() {
        ...
        // Colors change slightly for light mode
        if (isLight) {
           this.color = Math.random() > 0.4 ? "rgba(14, 165, 233, " : "rgba(99, 102, 241, ";
      ...
      draw() {
        ...
        if (!isLight) {
          ctx.shadowColor = this.color === "rgba(6, 182, 212, " ? "#06b6d4" : "#8b5cf6";
        }
        ctx.fill();
      }
    }
      ...
      for (let a = 0; a < particles.length; a++) {
        for (let b = a + 1; b < particles.length; b++) {
          ...
          if (distance < 130) {
            ...
            const lineColor = isLight ? `rgba(15, 23, 42, ${opacity * 0.1})` : `rgba(6, 182, 212, ${opacity * 0.15})`;
